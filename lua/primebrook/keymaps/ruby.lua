...
function M.setup()
	-- Add binding
	vim.keymap.set("n", "<leader>x", "obinding.pry<Esc>", { noremap = true, silent = true, buffer = true })
	vim.keymap.set("n", "<leader>X", "Obinding.pry<Esc>", { noremap = true, silent = true, buffer = true })

	-- Rufo format
	vim.keymap.set("n", "<leader>ff", ":!rufo %<CR>", { noremap = true, silent = true, buffer = true })
